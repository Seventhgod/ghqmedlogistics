      ...
      <div class="col-md-9 col-xl-7">
        ...
        <div class="card-body px-0">
          <div class="form-group">
            ...
            <input type="text" class="form-control" :class="{'is-invalid': errors.name}" v-model="user.name" placeholder="eg. Kofi Asamoah">
            <div class="invalid-feedback" v-if="errors.name">{{errors.name[0]}}</div>
          </div>
          <div class="form-group">
            <label>Email</label>
            <input type="email" class="form-control" :class="{'is-invalid': errors.email}" v-model="user.email" placeholder="eg. kofi@gaf.mil">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <multiselect
                    ...
                    track-by="id"
                    label="unit_name"
                    :class="{'border border-danger rounded': errors.unit}">>
                </multiselect>
                <small class="form-text text-danger" v-if="errors.unit">{{errors.unit[0]}}</small>
            </div>
        </div>
      </div>
    </div>
